...
const WhatIsARainyDayFund = () =>  {
    ...
    return (
	   ...
	   <h3>
		A rainy day fund, a.k.a. an	emergency fund is a savings account established for one purpose - 
	    	to weather a financial disaster, e.g. the loss of your job, 
		unexpected medical expenses, a much-needed car repair, etc.
	   </h3>

	   <h3>
		If you are like many Americans, you are not financially prepared for tough times. 
	   ...
	   <h3>
		...
		<br/><br/>
	        ...
	        <Button className="nav-btn" block>
	    		<Link className="link" to="Landing">Back to landing page</Link>
	    	</Button>
        </div>
    );
}
